import "./chunk-UUIHGFUJ.js";
import "./chunk-X6YHCJCB.js";
import "./chunk-G7HLSELF.js";
import "./chunk-C7H2BX76.js";
import "./chunk-VLFKST6J.js";
import "./chunk-EGRHWZRV.js";
import "./chunk-HXZC2UC6.js";
import "./chunk-Y4EHZJ6R.js";
import "./chunk-W4YH2I3Z.js";
import "./chunk-ERMM2ZDD.js";
import "./chunk-M5EKOYPZ.js";
import "./chunk-RPX6VIML.js";
import "./chunk-O6QFUROF.js";
import "./chunk-2FMLBNEP.js";
import "./chunk-5VZHYCWG.js";
import "./chunk-WHWNFVEE.js";
import "./chunk-W7OUDBQB.js";
import "./chunk-DQOAA4HW.js";
import "./chunk-L2RA4CZ6.js";
...
// node_modules/@strapi/plugin-cloud/dist/_chunks/App-Dzr5m4eZ.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var getTrad = (id) => `${pluginId}.${id}`;
var UploadIcon = () => (0, import_jsx_runtime.jsx)("svg", { width: "142", height: "74", viewBox: "0 0 142 74", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: (0, import_jsx_runtime.jsxs)("g", { opacity: "0.88", children: [
  ...
  (0, import_jsx_runtime.jsx)("path", { d: "M73.6731 73V39.8706", stroke: "white", strokeWidth: "2", strokeLinecap: "round" }),
  (0, import_jsx_runtime.jsx)(
    "path",
    {
      fillRule: "evenodd",
...
var CloudBox = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Box, { padding: 4, hasRadius: true, children: (0, import_jsx_runtime.jsxs)(Flex, { alignItems: "center", direction: "column", padding: 11, hasRadius: true, children: [
    (0, import_jsx_runtime.jsx)(EmptyStateIconWrapper$1, { paddingBottom: 6, "aria-hidden": true, children: (0, import_jsx_runtime.jsx)(UploadIcon, {}) }),
    (0, import_jsx_runtime.jsx)(Box, { paddingBottom: 4, children: (0, import_jsx_runtime.jsx)(Typography, { variant: "beta", tag: "p", textAlign: "center", textColor: "neutral1000", children: formatMessage({
      id: getTrad("Homepage.cloudBox.title"),
      defaultMessage: "Deploy to Strapi Cloud"
    }) }) }),
    (0, import_jsx_runtime.jsx)(Typography, { variant: "epsilon", tag: "p", textAlign: "center", textColor: "neutral600", children: formatMessage({
...
var LinkIcon = () => (0, import_jsx_runtime.jsxs)("svg", { width: "160", height: "88", viewBox: "0 0 160 88", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  (0, import_jsx_runtime.jsx)("g", { clipPath: "url(#clip0_7_368)", children: (0, import_jsx_runtime.jsxs)("g", { opacity: "0.84", children: [
    (0, import_jsx_runtime.jsx)(
      "path",
      {
        fillRule: "evenodd",
  ...
  (0, import_jsx_runtime.jsx)("defs", { children: (0, import_jsx_runtime.jsx)("clipPath", { id: "clip0_7_368", children: (0, import_jsx_runtime.jsx)("rect", { width: "158.4", height: "88", fill: "white", transform: "translate(0.800049)" }) }) })
] });
...
var GithubBox = () => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime.jsx)(Box, { padding: 4, children: (0, import_jsx_runtime.jsxs)(Flex, { alignItems: "center", direction: "column", padding: 11, children: [
    (0, import_jsx_runtime.jsx)(EmptyStateIconWrapper, { paddingBottom: 6, "aria-hidden": true, children: (0, import_jsx_runtime.jsx)(LinkIcon, {}) }),
    (0, import_jsx_runtime.jsx)(Box, { paddingBottom: 4, children: (0, import_jsx_runtime.jsx)(Typography, { variant: "beta", tag: "p", textAlign: "center", textColor: "neutral1000", children: formatMessage({
...
var HomePage = () => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime.jsxs)(Box, { paddingLeft: 10, paddingRight: 10, children: [
    (0, import_jsx_runtime.jsx)(RightSideCloudContainer, { children: (0, import_jsx_runtime.jsx)("img", { alt: "right-side-cloud", "aria-hidden": true, src: rightSideCloudPath }) }),
    (0, import_jsx_runtime.jsx)(LeftSideCloudContainer, { children: (0, import_jsx_runtime.jsx)("img", { alt: "left-side-cloud", "aria-hidden": true, src: leftSideCloudPath }) }),
    (0, import_jsx_runtime.jsx)(LogoContainer, { children: (0, import_jsx_runtime.jsx)("img", { alt: "strapi-corner-ornament", "aria-hidden": true, src: cornerOrnamentPath }) }),
    (0, import_jsx_runtime.jsxs)(Box, { paddingLeft: 10, paddingRight: 10, paddingBottom: 8, paddingTop: 10, children: [
      (0, import_jsx_runtime.jsx)(Flex, { justifyContent: "space-between", alignItems: "center", direction: "column", children: (0, import_jsx_runtime.jsx)(Flex, { minWidth: 0, children: (0, import_jsx_runtime.jsx)(Typography, { tag: "h1", variant: "alpha", children: formatMessage({
        id: getTrad("Homepage.title"),
        defaultMessage: "Fully-managed Cloud Hosting for your Strapi Project"
      }) }) }) }),
      (0, import_jsx_runtime.jsx)(Flex, { alignItems: "center", direction: "column", children: (0, import_jsx_runtime.jsx)(Typography, { variant: "epsilon", textColor: "neutral600", tag: "p", children: formatMessage({
    ...
    (0, import_jsx_runtime.jsxs)(Box, { padding: 10, children: [
      (0, import_jsx_runtime.jsxs)(Layouts.Grid, { size: "M", children: [
        (0, import_jsx_runtime.jsx)(GithubBox, {}),
        (0, import_jsx_runtime.jsx)(CloudBox, {})
      ] }),
      (0, import_jsx_runtime.jsxs)(Box, { padding: 6, borderRadius: 8, hasRadius: true, background: "neutral0", borderColor: "neutral200", children: [
        (0, import_jsx_runtime.jsx)(Box, { paddingBottom: 2, children: (0, import_jsx_runtime.jsx)(Typography, { variant: "delta", fontWeight: "bold", textColor: "neutral1000", tag: "p", children: formatMessage({
          id: getTrad("Homepage.textBox.label.versioned"),
          defaultMessage: "Try Strapi Cloud for Free!"
        }) }) }),
        (0, import_jsx_runtime.jsxs)(Typography, { variant: "epsilon", textColor: "neutral1000", tag: "p", children: [
          formatMessage({
          ...
          " ",
          (0, import_jsx_runtime.jsx)(Link, { href: "https://strapi.io/cloud?utm_campaign=Strapi%20Cloud%20Plugin&utm_source=In-Product&utm_medium=CTA", children: "Learn more" })
        ] })
      ] })
    ] })
  ] });
...
var App = () => {
  return (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsxs)(Routes, { children: [
...
//# sourceMappingURL=App-Dzr5m4eZ-LASHP7PA.js.map
