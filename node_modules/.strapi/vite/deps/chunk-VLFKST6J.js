...
// node_modules/@strapi/i18n/dist/_chunks/index-iEQ79W05.mjs
...
var LocaleOption = ({
  ...
  if (!entryExists) {
    return formatMessage(
      ...
      {
        bold: (locale2) => (0, import_jsx_runtime.jsx)("b", { children: locale2 }),
        locale: locale.name
      }
    );
  }
  return (0, import_jsx_runtime.jsxs)(Flex, { width: "100%", gap: 1, justifyContent: "space-between", children: [
    (0, import_jsx_runtime.jsx)(Typography, { children: locale.name }),
    isDraftAndPublishEnabled ? (0, import_jsx_runtime.jsx)(
      Status,
      {
        display: "flex",
        paddingLeft: "6px",
...
var LocalePickerAction = ({
  ...
  const allCurrentLocales = [
    { status: getDocumentStatus(document, meta), locale: currentLocale == null ? void 0 : currentLocale.code },
...
var addLabelActionToField = (field) => {
  ...
  const labelActionProps = {
    ...
    icon: isFieldLocalized ? (0, import_jsx_runtime.jsx)(ForwardRef$3J, {}) : (0, import_jsx_runtime.jsx)(ForwardRef$3H, {})
  };
  return {
    ...field,
...
var LocaleListCell = ({ locale: currentLocale, localizations }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Popover.Root, { children: [
    (0, import_jsx_runtime.jsx)(Popover.Trigger, { children: (0, import_jsx_runtime.jsx)(Button, { variant: "ghost", type: "button", onClick: (e) => e.stopPropagation(), children: (0, import_jsx_runtime.jsxs)(Flex, { minWidth: "100%", alignItems: "center", justifyContent: "center", fontWeight: "regular", children: [
      ...
      (0, import_jsx_runtime.jsx)(Flex, { children: (0, import_jsx_runtime.jsx)(ForwardRef$4L, { width: "1.2rem", height: "1.2rem" }) })
    ] }) }) }),
...
var index = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-B6QDUmu9-KISXLXHX.js").then((mod) => ({ default: mod.ProtectedSettingsPage })),
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/de.json": () => import("./de-9eCAqqrB-DIKNJRVS.js"), "./translations/dk.json": () => import("./dk-2qBjxt-P-4UCWN4LW.js"), "./translations/en.json": () => import("./en-DlXfy6Gy-SZG3UESB.js"), "./translations/es.json": () => import("./es-DlmMVaBG-LME6H2BI.js"), "./translations/fr.json": () => import("./fr-3S6ke71d-G6MKIIOM.js"), "./translations/ko.json": () => import("./ko-qTjQ8IMw-TJAF4GJ5.js"), "./translations/pl.json": () => import("./pl-B67TSHqT-Y27R7J4E.js"), "./translations/ru.json": () => import("./ru-hagMa57T-SAU2A6I4.js"), "./translations/tr.json": () => import("./tr-Dw_jmkG--U64YYHME.js"), "./translations/zh-Hans.json": () => import("./zh-Hans-Dyc-aR-h-BRU2ZDHC.js"), "./translations/zh.json": () => import("./zh-57YM4amO-DSRSNHHU.js") }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=chunk-VLFKST6J.js.map
