...
// node_modules/@strapi/upload/dist/_chunks/App-Um_gwZdg.mjs
...
var Header = ({
  ...
  return (0, import_jsx_runtime.jsx)(
    Layouts.Header,
    {
      ...
      subtitle: breadcrumbs && typeof breadcrumbs !== "boolean" && folder && (0, import_jsx_runtime.jsx)(
        Breadcrumbs,
        {
          label: formatMessage({
  ...
  return (0, import_jsx_runtime.jsxs)(Layouts.Root, { children: [
    (0, import_jsx_runtime.jsxs)(Page.Main, { children: [
      ...
      (0, import_jsx_runtime.jsxs)(Layouts.Content, { children: [
                  ...
                  Grid.Item,
                  {
                    ...
                    children: (0, import_jsx_runtime.jsx)(
                      FolderCard,
                      {
                        ...
                        id: `folder-${folder.id}`,
                        to: url,
                        startAction: folder.isSelectable ? (0, import_jsx_runtime.jsx)(
                          FolderCardCheckbox,
                          {
        ...
        (0, import_jsx_runtime.jsxs)(Pagination.Root, { ...assetsData == null ? void 0 : assetsData.pagination, children: [
...
var ConfigureTheView = React.lazy(
  async () => import("./ConfigureTheView-Cm7EfE0r-YQXT24QO.js").then((mod) => ({ default: mod.ConfigureTheView }))
);
var Upload = () => {
  const {
  ...
  return (0, import_jsx_runtime.jsx)(Page.Main, { children: rawQuery ? (0, import_jsx_runtime.jsx)(React.Suspense, { fallback: (0, import_jsx_runtime.jsx)(Page.Loading, {}), children: (0, import_jsx_runtime.jsxs)(Routes, { children: [
    (0, import_jsx_runtime.jsx)(Route, { index: true, element: (0, import_jsx_runtime.jsx)(MediaLibrary, {}) }),
    (0, import_jsx_runtime.jsx)(
      Route,
      {
        path: "configuration",
        element: (0, import_jsx_runtime.jsx)(ConfigureTheView, { config })
      }
    )
  ] }) }) : null });
};
...
//# sourceMappingURL=App-Um_gwZdg-GZP3ENC5.js.map
