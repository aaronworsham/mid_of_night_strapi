...
// node_modules/@strapi/admin/dist/admin/HomePage-idSom5Sg.mjs
...
var contentManager = adminApi.injectEndpoints({
  endpoints: (builder) => ({
    /**
     * Content Types
     */
...
var { useGetContentTypesQuery } = contentManager;
...
var HomePageCE = () => {
  ...
  return (0, import_jsx_runtime.jsxs)(Layouts.Root, { children: [
    ...
    (0, import_jsx_runtime.jsxs)(Main, { children: [
      (0, import_jsx_runtime.jsx)(LogoContainer, { children: (0, import_jsx_runtime.jsx)("img", { alt: "", "aria-hidden": true, src: cornerOrnamentPath }) }),
      (0, import_jsx_runtime.jsxs)(Box, { padding: 10, children: [
        (0, import_jsx_runtime.jsx)(Grid.Root, { children: (0, import_jsx_runtime.jsx)(Grid.Item, { col: 8, s: 12, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)(Box, { paddingLeft: 6, paddingBottom: 10, children: (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "flex-start", gap: 5, children: [
          (0, import_jsx_runtime.jsx)(Typography, { tag: "h1", variant: "alpha", children: hasAlreadyCreatedContentTypes ? formatMessage({
          ...
          (0, import_jsx_runtime.jsx)(WordWrap, { textColor: "neutral600", variant: "epsilon", children: hasAlreadyCreatedContentTypes ? formatMessage({
          ...
          hasAlreadyCreatedContentTypes ? (0, import_jsx_runtime.jsx)(Link, { isExternal: true, href: "https://strapi.io/blog", children: formatMessage({
            id: "app.components.HomePage.button.blog",
            defaultMessage: "See more on the blog"
          }) }) : (0, import_jsx_runtime.jsx)(Button, { size: "L", onClick: handleClick, endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$53, {}), children: formatMessage({
            id: "app.components.HomePage.create",
            defaultMessage: "Create your first Content type"
          }) })
        ] }) }) }) }) }),
        (0, import_jsx_runtime.jsxs)(Grid.Root, { gap: 6, children: [
          (0, import_jsx_runtime.jsx)(Grid.Item, { col: 8, s: 12, direction: "column", alignItems: "stretch", children: showGuidedTour ? (0, import_jsx_runtime.jsx)(GuidedTourHomepage, {}) : (0, import_jsx_runtime.jsx)(ContentBlocks, {}) }),
          (0, import_jsx_runtime.jsx)(Grid.Item, { col: 4, s: 12, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime.jsx)(SocialLinks, {}) })
        ] })
      ] })
    ] })
  ] });
...
`;
var WordWrap = dt(Typography)`
  word-break: break-word;
`;
var ContentBlocks = () => {
  const { formatMessage } = useIntl();
  const { trackUsage } = useTracking();
  return (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 5, children: [
    (0, import_jsx_runtime.jsx)(
      BlockLink,
      {
        ...
        children: (0, import_jsx_runtime.jsxs)(
          Flex,
          {
            ...
            gap: 6,
            children: [
              (0, import_jsx_runtime.jsx)(CloudCustomWrapper, { hasRadius: true, padding: 3, children: (0, import_jsx_runtime.jsx)(
                CloudIconWrapper,
                {
                  width: "3.2rem",
                  height: "3.2rem",
                  ...
                  hasRadius: true,
                  alignItems: "center",
                  children: (0, import_jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "15", fill: "none", children: (0, import_jsx_runtime.jsx)(
                    "path",
                    {
                      fill: "#fff",
                      fillRule: "evenodd",
              ...
              (0, import_jsx_runtime.jsxs)(Flex, { gap: 1, direction: "column", alignItems: "start", children: [
                (0, import_jsx_runtime.jsx)(Typography, { fontWeight: "semiBold", variant: "pi", textColor: "neutral800", children: formatMessage({
                  id: "app.components.BlockLink.cloud",
                  defaultMessage: "Strapi Cloud"
                }) }),
                (0, import_jsx_runtime.jsx)(Typography, { textColor: "neutral600", children: formatMessage({
                  id: "app.components.BlockLink.cloud.content",
                  defaultMessage: "Fully-managed cloud hosting for your Strapi project."
                }) }),
                (0, import_jsx_runtime.jsx)(Box, { src: cloudFlagsImage, position: "absolute", top: 0, right: 0, tag: "img" })
              ] })
            ]
          }
        )
      ...
      BlockLink,
      {
        ...
        children: (0, import_jsx_runtime.jsx)(
          ContentBox,
          {
            ...
            icon: (0, import_jsx_runtime.jsx)(ForwardRef$t, {}),
      ...
      BlockLink,
      {
        ...
        children: (0, import_jsx_runtime.jsx)(
          ContentBox,
          {
            ...
            icon: (0, import_jsx_runtime.jsx)(ForwardRef$$, {}),
      ...
      BlockLink,
      {
        ...
        children: (0, import_jsx_runtime.jsx)(
          ContentBox,
          {
            ...
            icon: (0, import_jsx_runtime.jsx)(ForwardRef$z, {}),
...
`;
var CloudCustomWrapper = dt(Box)`
  background-image: url(${cloudIconBackgroundImage});
`;
var CloudIconWrapper = dt(Flex)`
...
var SocialLinks = () => {
  ...
  const socialLinksExtended = [
    ...SOCIAL_LINKS,
    {
      icon: (0, import_jsx_runtime.jsx)(StyledStrapi, {}),
  ...
  return (0, import_jsx_runtime.jsxs)(
    Flex,
    {
      ...
      gap: 7,
      children: [
        (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 5, children: [
          (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 3, children: [
            (0, import_jsx_runtime.jsx)(Typography, { variant: "delta", tag: "h2", id: "join-the-community", children: formatMessage({
          ...
          (0, import_jsx_runtime.jsx)(Link, { href: "https://feedback.strapi.io/", isExternal: true, endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$3z, {}), children: formatMessage({
            id: "app.components.HomePage.roadmap",
            defaultMessage: "See our road map"
          }) })
        ] }),
        (0, import_jsx_runtime.jsx)(GridGap, { children: socialLinksExtended.map(({ icon, link, name }) => {
          return (0, import_jsx_runtime.jsx)(Grid.Item, { col: 6, s: 12, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime.jsx)(LinkCustom, { size: "L", startIcon: icon, variant: "tertiary", href: link, isExternal: true, children: formatMessage(name) }) }, name.id);
        }) })
      ]
    }
  );
};
var StyledGithub = dt(ForwardRef$x)`
  path {
    fill: ${(props) => props.theme.colors.neutral800} !important;
  }
`;
var StyledDiscord = dt(ForwardRef$T)`
  path {
    fill: #7289da !important;
  }
`;
var StyledReddit = dt(ForwardRef$d)`
  > path:first-child {
    fill: #ff4500;
  }
...
`;
var StyledStrapi = dt(ForwardRef$7)`
  > path:first-child {
    fill: #4945ff;
  }
  > path:nth-child(2) {
...
`;
var StyledTwitter = dt(ForwardRef$1)`
  path:first-child {
    fill: #fff;
  }
...
`;
var StyledDiscourse = dt(ForwardRef$R)`
  > path:first-child {
    fill: #231f20;
  }
  > path:nth-child(2) {
...
var HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import("./HomePage-BcKeFpnc-CIWB2PN7.js")).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=chunk-K36557BC.js.map
