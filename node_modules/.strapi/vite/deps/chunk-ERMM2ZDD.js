...
// node_modules/@strapi/content-type-builder/dist/_chunks/index-Bk6YsPtU.mjs
...
var Blocker = ({ displayedIcon, description: description2, title, isOpen }) => {
  ...
  return isOpen && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body) ? (0, import_react_dom.createPortal)(
    (0, import_jsx_runtime.jsxs)(Overlay, { id: "autoReloadOverlayBlocker", direction: "column", alignItems: "center", gap: 6, children: [
      ...
      displayedIcon === "reload" && (0, import_jsx_runtime.jsx)(IconBox, { padding: 6, background: "primary100", borderColor: "primary200", children: (0, import_jsx_runtime.jsx)(LoaderReload, { width: "3.6rem", height: "3.6rem" }) }),
...
var index = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./index-cD82V-TB-FN42ESQH.js").then((n) => n.i),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
//# sourceMappingURL=chunk-ERMM2ZDD.js.map
