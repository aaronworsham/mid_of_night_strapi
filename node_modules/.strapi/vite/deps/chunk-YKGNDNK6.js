...
// node_modules/@strapi/admin/dist/admin/Ornaments-BFThxr2U.mjs
...
var Number = ({ children, state, ...props }) => {
  return state === STATES.IS_DONE || state === STATES.IS_ACTIVE ? (0, import_jsx_runtime.jsx)(
    Flex,
    {
      ...
      ...props,
      children: state === STATES.IS_DONE ? (0, import_jsx_runtime.jsx)(ForwardRef$4x, { "aria-hidden": true, width: `1.6rem`, fill: "neutral0" }) : (0, import_jsx_runtime.jsx)(Typography, { fontWeight: "semiBold", textColor: "neutral0", children })
    }
    ...
    Flex,
    {
      ...
      justifyContent: "center",
      ...props,
      children: (0, import_jsx_runtime.jsx)(Typography, { fontWeight: "semiBold", textColor: "neutral600", children })
    }
  );
};
var VerticalDivider = ({ state, ...props }) => (0, import_jsx_runtime.jsx)(
  Box,
  {
    width: `0.2rem`,
    height: "100%",
...
//# sourceMappingURL=chunk-YKGNDNK6.js.map
