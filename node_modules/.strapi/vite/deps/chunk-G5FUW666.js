...
// node_modules/@strapi/admin/dist/admin/transferTokens-CQP13miB.mjs
  ...
  endpoints: (builder) => ({
    ...
    getTransferTokens: builder.query({
      ...
      providesTags: (res, _err) => [
        ...(res == null ? void 0 : res.map(({ id }) => ({ type: "TransferToken", id }))) ?? [],
...
//# sourceMappingURL=chunk-G5FUW666.js.map
