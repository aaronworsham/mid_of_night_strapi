...
// node_modules/@strapi/review-workflows/dist/_chunks/index-ByXbOW-R.mjs
        ...
        children: [
          ...
          (0, import_jsx_runtime.jsx)(
            SingleSelect,
            {
              ...
              startIcon: activeWorkflowStage && (0, import_jsx_runtime.jsx)(
                Flex,
                {
                  tag: "span",
                  height: 2,
              ...
              customizeContent: () => {
                return (0, import_jsx_runtime.jsxs)(Flex, { tag: "span", justifyContent: "space-between", alignItems: "center", width: "100%", children: [
                  (0, import_jsx_runtime.jsx)(Typography, { textColor: "neutral800", ellipsis: true, children: (activeWorkflowStage == null ? void 0 : activeWorkflowStage.name) ?? "" }),
                  isLoading ? (0, import_jsx_runtime.jsx)(Loader, { small: true, style: { display: "flex" }, "data-testid": "loader" }) : null
                ] });
              },
...
var Panel = () => {
  ...
  return {
    ...
    content: (0, import_jsx_runtime.jsxs)(Flex, { direction: "column", gap: 2, alignItems: "stretch", width: "100%", children: [
...
var StageColumn = (props) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Flex, { alignItems: "center", gap: 2, maxWidth: "30rem", children: [
    (0, import_jsx_runtime.jsx)(
      Box,
      {
        height: 2,
    ...
    (0, import_jsx_runtime.jsx)(Typography, { fontWeight: "regular", textColor: "neutral700", ellipsis: true, children: name })
  ] });
};
var AssigneeColumn = (props) => {
  const { strapi_assignee: user } = props;
  return (0, import_jsx_runtime.jsx)(Typography, { textColor: "neutral800", children: user ? getDisplayName(user) : "-" });
};
var REVIEW_WORKFLOW_COLUMNS = [
  {
    ...
    cellFormatter: (props) => (0, import_jsx_runtime.jsx)(StageColumn, { ...props })
  },
  {
    name: ASSIGNEE_ATTRIBUTE_NAME,
    attribute: {
    ...
    cellFormatter: (props) => (0, import_jsx_runtime.jsx)(AssigneeColumn, { ...props })
  }
];
...
var admin = {
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-BPl2HZMq-JIJXOXFU.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-DyFV_H0I-FBD3HNIF.js");
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/en.json": () => import("./en-D9dxziEb-GVKVCXRB.js") }), `./translations/${locale}.json`, 3).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=chunk-G7HLSELF.js.map
