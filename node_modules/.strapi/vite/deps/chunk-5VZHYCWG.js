...
// node_modules/@strapi/admin/dist/admin/useLicenseLimits-CcOoSJ8p.mjs
...
function useLicenseLimits({ enabled } = { enabled: true }) {
  ...
  return { license: data == null ? void 0 : data.data, getFeature, isError, isLoading };
}

export {
  useLicenseLimits
};
//# sourceMappingURL=chunk-5VZHYCWG.js.map
